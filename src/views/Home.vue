<template>
  ...
  <div class="grid">
    ...
    >
      ...
      <AboutButton />
      <div
        class="rounded-2xl border-2 border-gray-50 border-opacity-25 max-w-full my-auto sm:mx-2 sm:my-0 pt-0 p-4 sm:p-1 bg-gray-300 bg-opacity-40 shadow"
        id="home"
      >
        <div
        ...
        >
          <Time />
          <div>
            <Sound :bells="bells" @allLoaded="showSettings"/>
          </div>
          <div>
